...
fanimator(@(t) plot(x_1(t),y_1(t),'ro','MarkerSize',m_1*10,'MarkerFaceColor','r'),'AnimationRange',[0 30],'FrameRate',100);
axis equal;
hold on;
fanimator(@(t) plot([0 x_1(t)],[0 y_1(t)],'r-'),'AnimationRange',[0 30],'FrameRate',100);
fanimator(@(t) plot(x_2(t),y_2(t),'go','MarkerSize',m_2*10,'MarkerFaceColor','g'),'AnimationRange',[0 30],'FrameRate',100);
fanimator(@(t) plot([x_1(t) x_2(t)],[y_1(t) y_2(t)],'g-'),'AnimationRange',[0 30],'FrameRate',100);
fanimator(@(t) text(-0.3,0.3,"Timer: "+num2str(t,2)),'AnimationRange',[0 30],'FrameRate',100);
hold off;
playAnimation(gcf,'AnimationRange',[0 30],'FrameRate',100)
